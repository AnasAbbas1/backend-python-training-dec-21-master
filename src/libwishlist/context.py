...
class Context(ctxutil.ContextBase):
    ...
    def push(self):
        ...
        if self.isolation_level:
            self.conn = libwishlist.engine.connect().execution_options(isolation_level=self.isolation_level)
        else:
            self.conn = libwishlist.engine.connect()
